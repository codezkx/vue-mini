...
function isReactive(row) {
    ...
    return !!(row === null || row === void 0 ? void 0 : row[ReactiveFlags.IS_REACTIVE]);
}
function isReadonly(row) {
    return !!(row === null || row === void 0 ? void 0 : row[ReactiveFlags.IS_READONLY]);
}
...
function createRenderer(options) {
    ...
    */
    ...
    function isSameVNodeType(n1, n2) {
        return (n1 === null || n1 === void 0 ? void 0 : n1.type) === (n2 === null || n2 === void 0 ? void 0 : n2.type) && (n1 === null || n1 === void 0 ? void 0 : n1.key) === (n2 === null || n2 === void 0 ? void 0 : n2.key);
    }
    /**
     *
     * @description
...
function parseTag(context, type) {
    ...
    if (type === tagType.END)
        return; // 这里不需要生成新的tag 只是删除对应的字符串
    return {
        type: NodeTypes.ELEMENT,
        tag,
    };
...
function isText(node) {
    return (node === null || node === void 0 ? void 0 : node.type) === NodeTypes.TEXT || (node === null || node === void 0 ? void 0 : node.type) === NodeTypes.INTERPOLATION;
}
